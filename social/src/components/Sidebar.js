...
const Sidebar = ({ user, closeToggle }) => {
    ...
    return (
        <div className='flex flex-col justify-between bg-white h-full overflow-y-scroll w-300 hide-scrollbar'>
            <div className='flex flex-col'>
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <h6 className='mt-2 px-5 text-base xl:text-xl'> Discover Categories</h6>
            ...
            {user && (
                <Link
                    ...
                    className='flex my-5 mb-3 gap-2 items-center bg-white shadow-lg rounded-lg mx-3'
                    onClick={handleCloseSideBar}
                >
